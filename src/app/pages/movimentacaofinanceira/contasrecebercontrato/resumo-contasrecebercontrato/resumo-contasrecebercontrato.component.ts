...
@Component({
  selector: 'app-resumo-contasrecebercontrato',
  templateUrl: './resumo-contasrecebercontrato.component.html',
  styleUrls: ['./resumo-contasrecebercontrato.component.css']
})
export class ResumoContasrecebercontratoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.movimentoContratoService.getEvents().subscribe(
      rest => setTimeout(() => {
  ...
  quitar(id) {
    ...
    this.router.navigate( ['quitarcontasrecebercontrato',   this.index ,  id.event.id   ]);
    //this.router.navigate(['quitarcontasrecebercontrato' ,  { queryParams: {exercicio:this.index , id: id.event.id} } ]);
  }
  handleDateClick(arg) {
