...
@Component({
  selector: 'app-historicosaidapadrao',
  templateUrl: './historicosaidapadrao.component.html',
  styleUrls: ['./historicosaidapadrao.component.css'],
  styles: [`
  .front{
      z-index:2;
  }`]
})
export class HistoricosaidapadraoComponent implements OnInit {
  ...
  constructor(
    ...
    private historicopadraoService: HistoricopadraosaidaService,
